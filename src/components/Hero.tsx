      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center max-w-5xl relative z-10">
        <ParallaxSection speed={0.2}>
          <div className="relative">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[3.5rem] font-bold font-crimson mb-6 md:mb-8 text-foreground leading-tight relative break-words">

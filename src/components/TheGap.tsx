      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-foreground leading-relaxed font-source">
            Giữa một ý tưởng xuất sắc trong đầu bạn và một bài trình bày tầm thường trước đám đông là một "khoảng trống". Đó là nơi tiềm năng bị đánh mất, cơ hội bị bỏ lỡ, và giá trị không được công nhận
          </p>
        </div>
      </div>
    </section>
